...
// .wrangler/tmp/bundle-WIQQCJ/checked-fetch.js
...
var worker_default = {
  ...
  async fetch(request, env) {
    ...
    if (url.pathname === "/rebuild" && request.method === "POST") {
      const result = await triggerRebuild(env);
      return new Response(
        JSON.stringify({ ...result, timestamp: (/* @__PURE__ */ new Date()).toISOString() }),
        {
...
// .wrangler/tmp/bundle-WIQQCJ/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-WIQQCJ/middleware-loader.entry.ts
